...
an import path, backups, and a signer. The mapping code is extra
software with less review than Core. A person cannot be the whole
entropy pool and cannot audit Core’s generator with a calculator.
